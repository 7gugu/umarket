...
class steamauthOOP {
       private $settings = array(
        "apikey" => APIKEY, // Get yours today from http://steamcommunity.com/dev/apikey
        "domainname" => SYSTEM_NAME, // Displayed domain in the login-screen
        "loginpage" => WEBIP."/index.php?mod=register:1", // Returns to last page if not set
        "logoutpage" => "",
