...
/* SMTP Class
 * Example:
 * $x = new SMTP('smtp.qq.com',25,true,'gz7gugu@qq.com','*************');
 * $x->send('7gugu <gz7gugu@qq.com>','7gugu <gz7gugu@qq.com>','hello','Umarket');
 */
...
class SMTP {
    ...
    public function send($to, $from, $subject = "", $body = "", $fromname = "Umarket", $reply = '', $cc = "", $bcc = "", $additional_headers = "") {
        if (empty($reply)) {
            $reply = $from;
        }
        $header = "";
